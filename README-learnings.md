...
- Branding assets: usar `brandingAsset(...)` y filtrar placeholders `.svg`; thumbnails hacen fallback ordenado (thumbnail → instagram → mockups/merch → logos → palette → `/next.svg`).
